...
const ScheduleIcon = ({ onClick, color }) => {
  return (
...
const CommentIcon = ({ onClick, color }) => {
  return (
...
const BookmarkIcon = ({ onClick, color }) => {
  return (
...
const ProfileIcon = ({ onClick, color }) => {
  return (
